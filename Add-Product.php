...
<body id="app-layout">
		                ...
		                <form class="form-horizontal" action="action-form.php" method="POST">
                          <fieldset>
                            <div class="form-group">
                              ...
                              <div class="col-lg-10">
                                <input type="text" class="form-control" id="inputTitle" name="inputTitle" placeholder="Enter Product Name/ Title" required maxlength="255">
                              </div>
                            </div>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-lg-10">
                                <input type="text" class="form-control" id="inputSKU" name="inputSKU" placeholder="Enter unique SKU Code" required minlength="2" maxlength="10">
                              </div>
                            </div>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-lg-10">
                                <input type="text" class="form-control" id="inputDLY" name="inputDLY" placeholder="Delivery Charge (enter 0 for free)" required minlength="1" maxlength="10" >
                              </div>
                            </div>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-lg-10">
                                <select class="form-control" id="selectSubCat" name="selectSubCat">
                                    <option disabled value="0">Select main category first</option>
                                </select>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-lg-10">
                                <input type="text" name="inputQTY" class="form-control" id="inputQTY" placeholder="Enter initial stock" required minlength="1" maxlength="11">
                              </div>
                            </div>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-lg-10">
                                <input type="text" name="inputCP" class="form-control" id="inputCP" placeholder="Enter Unit Cost Price" required minlength="1" maxlength="15">
                              </div>
                            </div>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-lg-10">
                                <input type="text" class="form-control" name="inputSP"  id="inputSP" placeholder="Enter Unit Selling Price" required minlength="1" maxlength="15">
                              </div>
                            </div>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-lg-10">
                                <textarea class="form-control" rows="2" id="textDesc" name="textDesc"></textarea>
                            ...
                            <div class="form-group">
                              <div class="col-lg-10 col-lg-offset-2">
                                <button class="btn btn-success btn-lg pull-right" id="addProduct" name="addProduct">
                                    <i class="fa fa-cart-plus" aria-hidden="true"></i> Create New Product 
                                </button>
                              </div>
                            </div>
                            <input type="hidden" value="8861728005" name="addprod"/>
                          </fieldset>
                    </form>
	                </div>
    ...
    $(document).ready(function(){
        ...
        //Subcategory
        $("#selectSubCat").load("data-service.php?subcat=" + $("#selectCat").val());
